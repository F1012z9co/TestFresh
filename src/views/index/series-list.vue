<template>
  <div>
    <!-- *********************类别列表********************* -->
    <div class="series_list" v-for="items in list" :key="items.title">
      <div class="series_box cle">
        <div class="series_info">
          ...
          <div class="brand_cata">
            <!-- 二级分类 -->
            <router-link v-for="label in items.sub_cat" :key="label.id" :title="label.name" :to="'/app/home/list/'+label.id">{{label.name}}</router-link>
          </div>
