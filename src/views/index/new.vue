      ...
      <div class="w-max ct bgwh mb30 ovh border-eee">
        ...
        <div class="newopro-r fr">
          <h2 class="index-tt">
            ...
            <a href="list/more" target="_blank" class="fr c666">更多&gt;&gt;</a>
          </h2>
          <ul class="newgoods_fastbuy">
            <li class="prolist-cent clearfix have_num" v-for="item in newopro" :key="item.id">
              <div class="prolist-l fl">
                <router-link :to="'/app/home/productDetail/'+item.id" target="_blank" :title="item.name" class="imgBox">
              ...
              <div class="prolist-r fl">
                    ...
                    <router-link :to="'/app/home/productDetail/'+item.id" class="p-buy fr ibg">立即抢购</router-link>
...
.p-buy{width: 188px; height: 56px; line-height: 56px; font-weight:bold; font-size: 18px; text-indent: 78px; background-position: 0 -36px; margin-left: 25px;}
