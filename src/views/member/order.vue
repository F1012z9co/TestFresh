            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tbody>
                ...
                <tr v-for="(item, index) in orders" :key="index">
                  ...
                  <td align="center" bgcolor="#ffffff" v-if="item.pay_status == 'paying' ">待支付</td>
                  <td align="center" bgcolor="#ffffff" v-if="item.pay_status == 'TRADE_SUCCESS' ">已支付</td>
                  <td align="center" bgcolor="#ffffff"><font class="f6"><a @click="cancelOrder(index, item.id)">取消订单</a></font></td>
                </tr>
...
<script>
import { getOrders, delOrder } from '../../api/api'
