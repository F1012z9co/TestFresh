  ...
  <div class="slidebar">
    ...
    <ul class="slide_item">
      <li class="item">
        ...
        <ul>
          <li>
            <a :class="{on: current==='order' || current==='orderDetail'}" @click="toOrder">我的订单</a>
...
export default {
  ...
  created () {
    ...
    if (temp.length === 5) {
      this.current = temp[temp.length - 1] // /app/home/member/order
    } else {
      this.current = temp[temp.length - 2] // /app/home/member/orderDetail/111
    }
