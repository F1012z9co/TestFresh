              ...
              <table width="100%" border="0" cellpadding="3">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="radio" id="one" name="msg_type" value="1" v-model="message_type">
                      <label for="one">留言</label>
                      <input type="radio" id="two" name="msg_type" value="2" v-model="message_type">
                      <label for="two">投诉</label>
                      <input type="radio" id="three" name="msg_type" value="3" v-model="message_type">
                      <label for="three">询问</label>
                      <input type="radio" id="four" name="msg_type" value="4" v-model="message_type">
                      <label for="four">售后</label>
                      <input type="radio" id="five" name="msg_type" value="5" v-model="message_type">
...
export default {
  ...
  methods: {
    ...
    preview (event) {
      this.file = event.target.files[0] // 获取文件资源
