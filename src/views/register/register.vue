          ...
          <div class="tab-form">
            <form id="mobile_register_form" autocomplete="off">
              ...
              <div class="form-group marb8">
                <label>手&nbsp;机&nbsp;号</label>
                <input id="jsRegMobile" name="account" placeholder="请输入您的手机号码" v-model="mobile">
              </div>
              ...
              <div class="clearfix">
                <div class="form-group marb8 verify-code">
                  <label>短信验证码</label>
                  <input id="jsPhoneRegCaptcha" type="text" placeholder="输入手机验证码" v-model="code">
                </div>
                <input class="verify-code-btn sendcode" type="button" id="jsSendCode" :value="getMessageText" @click="seedMessage">
              </div>
              ...
              <input class="btn btn-green" id="jsMobileRegBtn" type="button" value="注册并登录" @click="isRegister">
            </form>
          </div>
  ...
  methods: {
    ...
    isRegister () {
      register({
        ...
        cookie.setCookie('name', this.mobile, 7)
        ...
        this.error.username = error.mobile ? error.mobile[0] : ''
