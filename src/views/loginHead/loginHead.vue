  ...
  <div>
    <div id="header">
      <div class="hd_bar" id="userinfo-bar">
        <div class="bd">
          <div class="logo">
            <router-link :to="'/app/home/index'">生鲜商城</router-link>
          </div>
...
#header .logo a {
    ...
    padding-top:60px;
    overflow:hidden;
    background:#09c762 url(../../../static/images/loginHead/logo.jpg) center 0 no-repeat
}
.hd_bar .bd {
    padding-left:230px;
    width:826px;
...
.hd-step li i {
    ...
    border-width:8px;
    border-style:solid;
    border-color:#09c762 #09c762 #f8f8f8 #09c762;
    display:none
}
.hd-step li.first {
    width:auto
